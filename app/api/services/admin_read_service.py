...
class AdminReadService:
    ...
    async def list_users(self) -> dict[str, Any]:
        ...
        return await self._db.async_execute(
            _query, operation_name="admin_list_users", read_only=True
        )

    async def job_status(self, *, today: _dt.datetime) -> dict[str, Any]:
        def _query() -> dict[str, Any]:
            from app.db.models import ImportJob, Request
        ...
        return await self._db.async_execute(
            _query, operation_name="admin_job_status", read_only=True
        )
    ...
    async def content_health(self) -> dict[str, Any]:
        ...
        return await self._db.async_execute(
            _query,
            operation_name="admin_content_health",
            read_only=True,
        )
    ...
    async def system_metrics(self, *, since: _dt.datetime) -> dict[str, Any]:
        def _query() -> dict[str, Any]:
            ...
            db_info = SystemMaintenanceService().get_db_info()
        ...
        return await self._db.async_execute(
            _query,
            operation_name="admin_system_metrics",
            read_only=True,
        )
    ...
    async def audit_log(
        ...
        *,
        ...
        return await self._db.async_execute(
            _query, operation_name="admin_audit_log", read_only=True
        )
