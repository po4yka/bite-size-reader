...
from app.adapters.forward_content_processor import ForwardContentProcessor
from app.adapters.forward_summarizer import ForwardSummarizer
...
class ForwardProcessor:
    ...
    async def handle_forward_flow(
        ...
        try:
            ...
            logger.exception("forward_flow_error", extra={
