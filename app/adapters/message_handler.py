...
from app.adapters.access_controller import AccessController
from app.adapters.command_processor import CommandProcessor
from app.adapters.message_router import MessageRouter
from app.adapters.url_handler import URLHandler
    ...
    def _audit(self, level: str, event: str, details: dict) -> None:
        ...
        try:
            self.db.insert_audit_log(
                level=level, event=event, details_json=json.dumps(
