...
class RequestRepositoryPort(Protocol):
    ...
    async def async_create_minimal_request(self, *args: Any, **kwargs: Any) -> int: ...
...
class UserRepositoryPort(Protocol):
    ...
    async def async_update_user_preferences(self, user_id: int, **kwargs: Any) -> None: ...
...
class VideoDownloadRepositoryPort(Protocol):
    ...
    async def async_update_video_download_status(
        self, download_id: int, status: str, **kwargs: Any
    ) -> None: ...
...
class BatchSessionRepositoryPort(Protocol):
    ...
    async def async_add_batch_session_item(self, *args: Any, **kwargs: Any) -> None: ...
