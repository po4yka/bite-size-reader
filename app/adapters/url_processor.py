...
from app.adapters.content_chunker import ContentChunker
from app.adapters.content_extractor import ContentExtractor
from app.adapters.firecrawl_parser import FirecrawlClient
from app.adapters.llm_summarizer import LLMSummarizer
from app.adapters.message_persistence import MessagePersistence
    ...
    async def handle_url_flow(
        ...
        *,
        ...
        try:
            ...
            logger.error("url_flow_error", extra={
