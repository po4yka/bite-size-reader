...
print("📋 This example demonstrates the API structure for Phase 3 features\n")

# Example 1: Parallel Batch Processing
print("1️⃣  Parallel Batch Processing")
print("=" * 60)
print()
...
print('        print(f"✅ {result.url}: Success")')
print("    else:")
print('        print(f"❌ {result.url}: {result.error}")')
print("```")
print()
print("Key Features:")
print("  • Semaphore-based concurrency limiting")
print("  • Parallel processing of multiple URLs")
print("  • Individual error handling per URL")
print("  • Batch summary logging")
print()

# Example 2: Streaming Pipeline
print("2️⃣  Streaming Pipeline with Progress Updates")
print("=" * 60)
print()
...
print('            print("✅ Pipeline complete!")')
print("            output = update['output']")
print('            print(f"   Summary attempts: {output.summarization_attempts}")')
print("```")
print()
print("Progress Updates:")
print("  • Stage: EXTRACTION (10-40%)")
print("  • Stage: SUMMARIZATION (50-90%)")
print("  • Stage: COMPLETE (100%)")
print("  • Metadata: content_length, attempts, corrections")
print()

# Example 3: Advanced Retry Strategies
print("3️⃣  Advanced Retry Strategies")
print("=" * 60)
print()
...
print("  • EXPONENTIAL: 1s → 2s → 4s → 8s → 16s (with multiplier 2.0)")
print("  • LINEAR: 1s → 2s → 3s → 4s → 5s")
print("  • FIXED: 5s → 5s → 5s → 5s → 5s")
print("  • NONE: No delays between attempts")
print()

# Example 4: State Persistence
print("4️⃣  Pipeline State Persistence")
print("=" * 60)
print()
...
print("  • Saves after extraction stage")
print("  • Saves after summarization stage")
print("  • Resumes from last completed stage")
print("  • Cleans up state file on completion")
print("  • State files: /tmp/pipeline_states/<correlation_id>.json")
print()

# Example 5: Combined Features
print("5️⃣  Combined Features Example")
print("=" * 60)
print()
...
print()
print("Phase 2:")
print("  ✅ ContentExtractionAgent - Message-independent extraction")
print("  ✅ SummarizationAgent - Message-independent summarization")
print("  ✅ Complete pipeline without Telegram dependencies")
print()
print("Phase 3:")
print("  ✅ Parallel batch processing (execute_batch_pipeline)")
print("  ✅ Streaming progress updates (execute_pipeline_streaming)")
print("  ✅ Advanced retry strategies (RetryConfig + RetryStrategy)")
print("  ✅ Pipeline state persistence (PipelineState)")
print()
print("Use Cases:")
print("  • Batch: Process RSS feeds, scrape multiple pages")
print("  • Streaming: Long articles with progress bars")
print("  • Retry: Handle flaky API calls with backoff")
print("  • Persistence: Resume interrupted batch jobs")
print()
print("Next Steps:")
