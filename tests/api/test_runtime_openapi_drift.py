"""Strict drift test: runtime-generated OpenAPI vs hand-written YAML.
...
* Comparing ``components.schemas`` key sets using the YAML-as-source-of-truth
  convention: every concrete runtime schema (excluding internal Pydantic /
  validation noise) must appear in the YAML. The YAML may carry additional
  hand-written envelope schemas not auto-generated by FastAPI.
