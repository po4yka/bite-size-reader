...
mod tests {
    ...
    #[test]
    fn slash_message_waiting_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0095}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_start_of_guarded_area_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0096}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_start_of_string_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0098}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_single_graphic_character_introducer_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0099}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_single_character_introducer_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{009A}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_control_sequence_introducer_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{009B}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_operating_system_command_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{009D}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_privacy_message_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{009E}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_application_program_command_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{009F}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_null_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0000}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_start_of_heading_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0001}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_start_of_text_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0002}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_end_of_text_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0003}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
    ...
    #[test]
    fn slash_end_of_transmission_command_like_text_is_not_handled() {
        let decision = resolve_command_route(&TelegramCommandRouteInput {
            text: "/\u{0004}findonline rust".to_string(),
        });
        assert_eq!(decision.command, None);
        assert!(!decision.handled);
    }
